game.StarterGui:SetCore("SendNotification", {
    ...
    Text = "LOADING THE COMPLICATED STUFF"; -- what the text says (ofc)
...
TextLabel.MouseButton1Down:Connect(function()
	...
	print("Chanbe Scripts is loaded kinda")end)
...
game.StarterGui:SetCore("SendNotification", {
    ...
    Text = "LOADING UI"; -- what the text says (ofc)
...
local Window = Library.CreateLib("V696969 CHANBE", "BloodTheme")
...
local Tab2Section = Tab2:NewSection("Cool")

Tab2Section:NewButton("InfJump", "ButtonInfo", function()
...
part.Position = position - Vector3.new(0, 3, 0) -- place the part just below the player's feet
...
-- play a sound effect to indicate the part has been created

local sound = Instance.new("Sound")

sound.SoundId = "rbxassetid://151205906" -- insert your own sound effect here
...
local Tab3Section = Tab4:NewSection("Effects")

Tab3Section:NewButton("Light","Opens Light",function()

loadstring(game:HttpGet("https://pastebin.com/raw/QSR8pjFn",true))()

end)

Tab3Section:NewButton("Make You Feel Angry","Opens Make You Feel Angry",function()

loadstring(game:HttpGet("https://pastebin.com/raw/0W2VG7DZ",true))()

end)

Tab3Section:NewButton("Make You Feel Cool","Opens Make You Feel Cool",function()
...
Tab3Section:NewButton("JN Cape", "Opens JN Cape", function()
...
Tab3Section:NewButton("NightBed Cape","Opens NightBed Cape",function()

loadstring(game:HttpGet("https://raw.githubusercontent.com/NTDCore/CapePACK/main/Nightbed.Cape%3F.lua",true))()

end)

Tab3Section:NewButton("Cape", "Opens Cape", function()
